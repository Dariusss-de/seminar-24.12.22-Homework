...
Для перехода на другую ветку используется команда *git checkout* Для этого в терминале с папкой репозиторием пишим команду *git checkout <название ветки>. Для перехода на ветку, ветка должна быть создана.
